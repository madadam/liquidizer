...
this is completely up to you. For example, you can associate the templates for example with the
Blog model (to follow the blog example) and have something like current_blog, which is loaded by
...
Potentialy many more. In any case, it's open source project (MIT), so no fear, fork me and hack!
